...
public class TicketMasterAPI {
	...
	private static final String API_KEY = "h7B7orQGbHvanT1iAcD5uGfTVOhzcTd2";
	...
	public List<Item> search(double lat, double lon, String keyword) {
		...
		String query = String.format("apikey=%s&geoPoint=%s&keyword=%s&radius=%s", API_KEY, geoHash, keyword, 5000);
		try {
